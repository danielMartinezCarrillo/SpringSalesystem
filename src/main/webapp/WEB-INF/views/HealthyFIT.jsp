...
<section id="testimonials" class="py-3">
  <div class="container">
    <div class="testimonial bg-primary">
      ...
      <h3>ChocolateMix </h3>&nbsp;
         <ul>
			<br><h4><li>2 Cucharadas De Cacao Natural </li></h4>
			<h4><li>YogurtNatural </li></h4>
			<h4><li>60g de HealthyFIT</li></h4>
		</ul>
    </div>
    <div class="testimonial bg-primary">
      <img src="/images/cake.png" alt="Camara" class="marg2">
      <ul>
      	<h3>Healthy Cake</h3>&nbsp;
   ...
   <div class="testimonial bg-primary">
      ...
      <ul>
			...
			<h4><li>60g de HealthyFIT</li></h4>
				...
				<h4> <li> Incorporamos la mezcla y cubrimos con unas pepitas y unas nueces (opcional). Introducimos al horno durante 30-35 minutos a 180º.</li></h4>
		</ul>
    </div>
  </div>
  </div>
