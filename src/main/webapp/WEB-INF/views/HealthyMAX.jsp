...
<div class="row">
    ...
    <div class="column" style="background-color:rgb(255, 255, 255);">
      <h2 style="text-align: center;"><b>HealthyMIX MAX</b></h2>
      <br>
      <h4 style="line-height: 25px; text-align: justify; text-justify: inter-word; font: size 17px; margin-left: 10px; margin-right: 10px;">HealthyMAX es una botana enfocada para las personas amantes de la fruta deshidratada incluyendo ingredientes saludables y deliciosos para el paladar.</p>
      <br>
        <h4 style="line-height: 25px; text-align: justify; text-justify: inter-word; font: size 17px; margin-left: 10px; margin-right: 10px;">HealthyMAX se destaca por los siguientes ingredientes:</p>
        <h4><li style="line-height: 15px; text-align: justify; text-justify: inter-word; font: size 17px; margin-left: 10px; margin-right: 10px;">Piña deshidratada</li></h4>
        <h4><li style="line-height: 15px; text-align: justify; text-justify: inter-word; font: size 17px; margin-left: 10px; margin-right: 10px;">Coco deshidratado</li></h4>
        <h4><li style="line-height: 15px; text-align: justify; text-justify: inter-word; font: size 17px; margin-left: 10px; margin-right: 10px;">Papaya deshidratada</li></h4>
        <br>
        <h4 style="line-height: 25px; text-align: justify; text-justify: inter-word; font: size 17px; margin-left: 10px; margin-right: 10px;">Todos nos merecemos una botana rica y saludable y esta es la indicada para degustar y así pasar un buen rato y relajarte.</h4>
    </div>
</div>

  <section id="testimonials" class="py-3">
    <div style= "color: #43a047;"class="container">
        <div class="testimonial bg-primary3">
            <h2 style="font-size: 40px; color: #68c46c;"><b>Recetas</b></h2>
            <h4 style="text-align: center;">Algunas recetas deliciosas que se pueden preparar con el producto de <b>HealthyMAX</b> son:</h4>
            <br>
        </div>
    ...
    <div class="testimonial bg-primary3">
        <img src="/images/ensalada.jpg" alt="Camara" class="marg2">
        <h3><b>Ensalada Frutal</b></h3>&nbsp;
            <ul>
                <h4><li>Espinacas </li></h4>
                <h4><li>1/2 Mango </li></h4>
                <h4><li>5 Fresas </li></h4>
                <h4><li>Aderezo de fruta de su agrado </li></h4>
                <h4><li>60g de HealthyMAX</li></h4>
		    </ul>
    </div>
...
<br>
<!-- Footer -->
<footer class="colorbod" class="text-light" style="margin-top: 440px;">
    <div class="container">
        <div class="row">
