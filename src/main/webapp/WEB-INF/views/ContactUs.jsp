...
<div class="mapouter" ><div class="gmap_canvas"><iframe float="right" width="500" height="400" id="gmap_canvas" src="https://maps.google.com/maps?q=monterrey&t=k&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>Google Maps Generator by <a href="https://www.embedgooglemap.net">embedgooglemap.net</a></div><style>.mapouter{position:relative;text-align:right;height:400px;width:500px; float:right;}.gmap_canvas {overflow:hidden;background:none!important;height:400px;width:500px; float:right; }</style></div>
